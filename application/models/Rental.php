 ...
 * @copyright 2010
 */
class Rental extends Zend_Db_Table{
    ...
    public function get_rental_list_rows($rental_id,$quick_search,$arr_limit,$arr_order)
    {
    ...
    public function get_rental_list_rows_count($rental_ids,$quick_search)
    {
        $select =   $this->DB->select();
