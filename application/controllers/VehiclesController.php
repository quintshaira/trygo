...
class VehiclesController extends Zend_Controller_Action
{
    ...
    public function submitrequestAction()
    {
        ...
        $garage                 = trim($this->_request->getParam('garage', ''));
        ...
        if ($idd) {
            ...
            $lastRequestId = $ob_Vehicles->add_rental(
                $company_id,
                $assigned_vehicle_name,
                $vehicle_type_id,
                $max_passenger,
    ...
    public function advancesearchAction()
    {
        ...
        if ($_POST) {
            ...
            $row_count=$ob_Vehicle->get_rental_list_rows_count1(
                $company_id,
                $max_passenger,
                $vehicle_type_id,
                $transmission_id,
            ...
            $this->view->rental_rows=$ob_Vehicle->search_vehicle_advance(
                $company_id,
                0,
                0,
                0,
